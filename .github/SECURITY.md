...
Replace all {{PLACEHOLDER}} values with your information:
  KitchenSpeak     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  kitchenspeak             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/kitchenspeak/security/advisories/new)
...
- This repository (`hyperpolymath/kitchenspeak`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/kitchenspeak/security/advisories)
...
When using KitchenSpeak, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/kitchenspeak/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/kitchenspeak/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/kitchenspeak/discussions) |
...
*Thank you for helping keep KitchenSpeak and its users safe.* 🛡️
